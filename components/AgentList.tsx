      ...
      <div className="flex gap-4 mb-8">
        ...
        <div className="w-64 relative">
          ...
          <select
            ...
            className="w-full bg-white dark:bg-[#121214] border border-zinc-300 dark:border-zinc-800 rounded-lg pl-10 pr-4 py-2 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 appearance-none"
          >
            ...
            >
              ...
              <div className="mb-4">
                <div className="flex justify-between items-baseline">
                  <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-1">{agent.name || 'Untitled Agent'}</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  <div className="px-2 py-0.5 rounded bg-indigo-100 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-400 text-[10px] font-bold uppercase tracking-wider border border-indigo-200 dark:border-indigo-900/30 inline-block">
                    {agent.domain}
                  </div>
                </div>
                  ...
                  <div className="space-y-1.5 mb-4">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {agentToolNames.map((name, i) => (
                        <span key={i} className="px-2 py-0.5 rounded bg-amber-100 text-amber-700 dark:bg-amber-900/10 dark:text-amber-500 text-[9px] font-bold border border-amber-200 dark:border-amber-900/20">
                          {name}
                        </span>
                      ))}
                    </div>
              ...
              <div className="mt-auto pt-4 border-t border-zinc-200 dark:border-zinc-800/50">
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-zinc-100 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 text-[10px] text-zinc-700 dark:text-zinc-300 font-medium">
