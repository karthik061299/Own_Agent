  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h2 className="text-3xl font-bold text-zinc-100 mb-2">Capabilities & Tools</h2>
          <p className="text-zinc-400">Custom functions agents can invoke to interact with the outside world.</p>
        </div>
        <button
          onClick={onCreate}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredTools.map((tool) => (
          ...
          >
            ...
            <div className="mb-4">
              <h3 className="text-lg font-bold text-zinc-100 mb-1">{tool.name}</h3>
            ...
            <div className="mt-auto pt-4 border-t border-zinc-800/50 flex items-center justify-between">
              <div className="flex items-center gap-2 text-[10px] font-bold text-indigo-400 bg-indigo-900/10 px-2 py-1 rounded border border-indigo-900/20 uppercase tracking-widest">
